...
export default function Explore() {
  return (
    <main className="font-int bg-[#F3F4F6]">
      ...
      {/* ── Hero Section ── */}
      <section className="h-[603px] max-md:h-[400px] w-full relative overflow-hidden">
        <Image
        ...
        <div className="absolute inset-0 z-10 bg-[#000000]/45 pl-[50px] max-md:pl-[20px] max-md:pr-[20px] pb-[200px] max-md:pb-[120px] flex flex-col justify-end">
          <h1 className="font-bold text-white text-[48px] max-md:text-[28px] leading-[61px] max-md:leading-[1.3]">
            Chuks Kitchen
          </h1>
          <p className="text-[24px] max-md:text-[16px] leading-[34px] max-md:leading-[24px] font-bold max-md:font-medium text-white">
      ...
      <section className="mt-[50px] max-md:mt-[30px] px-[48px] max-lg:px-[24px] max-md:px-[16px]">
        <h2 className="text-[32px] max-lg:text-[26px] max-md:text-[22px] font-bold leading-[42px] text-[#1F2937] mb-[20px] max-md:mb-[16px]">
          Popular
        </h2>

        <div className="flex flex-wrap gap-[63px_48px] max-xl:gap-[28px] max-lg:gap-[18px] max-md:flex-col max-md:gap-[12px]">
          {explorePopular.map((item, index) => (
            <div
              key={index}
              className="w-[416px] h-[465px] max-xl:w-[280px] max-xl:h-[410px] max-lg:w-[220px] max-lg:h-[340px] max-md:w-full max-md:h-[111px] bg-white rounded-[8px] flex flex-col max-md:flex-row items-center"
            >
              <div className="relative w-full max-md:w-[111px] max-md:shrink-0 h-[222px] max-xl:h-[190px] max-lg:h-[150px] max-md:h-full">
                <Image
                  fill
                  src={item.img}
                  alt={item.name}
                  className="object-cover rounded-[8px_8px_0_0] max-md:rounded-[8px_0_0_8px]"
                />
              </div>
