...
export default function Footer() {
  return (
    <footer className=" footer flex flex-col items-center text-center w-full h-[449px] py-[65px] gap-[4px] ">
      <div className="flex flex-row justify-center items-start padding-[0px_110px] gap-[101px] ">
        <div className="flex flex-col items-start w-[229.25px] h-[218px] ">
          <h2 className="font-island text-[#FF7A18] leading-[37px] text-[37px] ">
            Chuks Kitchen
          </h2>
          <p className="font-jost text-[#FFFFFF] text-[24px] leading-[36px] text-left ">
        ...
        <div className="flex flex-col items-start w-[229.25px] h-[218px] ">
          ...
          <ul className="flex flex-col items-start w-[229.25px] h-[218px] ">
            <li>
              <a
                href="#"
      ...
      <div className="mt-[36px] flex justify-between items-center w-full px-[110px] ">
