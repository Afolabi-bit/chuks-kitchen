...
export default function Header() {
  ...
  return (
    <>
      <header className="relative z-50 flex justify-between items-center w-full h-[90px] p-[18px_24px] gap-[20px] md:p-[18px_32px] md:gap-[20px] lg:p-[18px_48px] lg:gap-[28px] xl:p-[18px_48px] xl:gap-[45px]">
